...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{__('messages.Invoices')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/{{__('messages.UnPaid Invoices')}}
                </span>
            </div>
        </div>
                ...
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <a href="invoices/create" class="modal-effect btn btn-sm btn-primary" style="color:white"><i
                                class="fas fa-plus"></i>&nbsp;{{__('messages.Add Invoice')}}</a>
                    </div>
                </div>
                <div class="card-body">
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                <button aria-expanded="false" aria-haspopup="true"
                                                    ...
                                                    type="button">{{__('messages.Actions')}}<i class="fas fa-caret-down ml-1"></i></button>
                                                <div class="dropdown-menu tx-13">
                                                    <a class="dropdown-item"
                                                        href=" {{ url('edit_invoice') }}/{{ $invoice->id }}">{{__('messages.Edit Invoice')}}</a>
                                                    ...
                                                    <a class="dropdown-item"
                                                        href="{{ URL::route('Status_show', [$invoice->id]) }}"><i
                                                            class=" text-success fas fa-money-bill"></i>&nbsp;&nbsp;{{__('messages.Change Status')}}
                                                        </a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">{{__('messages.Delete Invoice')}}</h5>
