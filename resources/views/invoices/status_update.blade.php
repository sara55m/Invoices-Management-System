        ...
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{__('messages.Invoices')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                    {{__('messages.Change Status')}}</span>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('Status_Update', ['id' => $invoices->id]) }}" method="post" autocomplete="off">
                        ...
                        <div class="row">
                            <div class="col">
                                <label for="exampleTextarea">{{__('messages.Payment Status')}}</label>
                                <select class="form-control" id="Status" name="Status" required>
                                    <option selected="true" disabled="disabled">-- {{__('messages.Select')}} {{__('messages.Payment Status')}}--</option>
                                    <option value="Paid">{{__('messages.Paid')}}</option>
                                    <option value="Partially Paid ">{{__('messages.Partially Paid')}}</option>
                                </select>
                            </div>

                            <div class="col">
                                <label>{{__('messages.Payment Date')}}</label>
                        ...
                        <div class="d-flex justify-content-center">
                            <button type="submit" class="btn btn-primary">{{__('messages.Change Status')}}</button>
                        </div>
