...
Route::get('/home', [HomeController::class, 'index'])->name('home')->middleware('status');
...
Route::post('Status_Update/{id}',[InvoicesController::class,'Status_Update'])->name('Status_Update')->middleware('Change Payment Status');
