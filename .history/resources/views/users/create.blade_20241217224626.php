...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">{{__('messages.USERS')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/{{__('messages.Add User')}}</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
                    ...
                    <div class="row row-sm mg-b-20">
                        <div class="col-lg-6">
                            ...
                            <select name="status" id="select-beast" class="form-control  nice-select  custom-select">
                                ...
                                <option value="not active">{{__('messages.not active')}}</option>
                            </select>
                        </div>
                    </div>
