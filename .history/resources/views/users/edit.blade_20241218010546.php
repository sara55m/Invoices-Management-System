...
@section('title')
{{__('messages.Edit')}} {{__('messages.User')}}
@stop
...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">{{__('messages.USERS')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/{{__('messages.Edit')}} {{__('messages.User')}}</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
            ...
            <div class="card-body">
                ...
                <form class="parsley-style-1" id="selectForm2" autocomplete="off" name="selectForm2"
                    ...
                    <div class="row mg-b-20">
                        ...
                        <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
                            <label>{{__('messages.Confirm')}} {{__('messages.Password')}} : <span class="tx-danger">*</span></label>
                            <input class="form-control form-control-sm mg-b-20" data-parsley-class-handler="#lnWrapper"
                    ...
                    <div class="row row-sm mg-b-20">
                        <div class="col-lg-6">
                            <label class="form-label">{{__('messages.userstatus')}}</label>
                            <select name="status" id="select-beast" class="form-control  nice-select  custom-select">
                                <option value="active" {{$user->Status=='active' ? 'selected': ''}}>{{__('messages.active')}}</option>
                                <option value="not active" {{$user->Status=='not active' ? 'selected': ''}}>{{__('messages.not active')}}</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row mg-b-20">
                        <div class="col-xs-12 col-md-12">
                            <div class="form-group">
                                <label class="form-label">{{__('messages.User Authority')}}</label>
                    ...
                    <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
                        <label>{{__('messages.Image')}} : <span class="tx-danger">*</span></label>
                        <p class="text-danger">{{__('messages.Image Format')}} : pdf, jpeg ,jpg , png </p>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                        <button class="btn btn-main-primary pd-x-20" type="submit">{{__('messages.Edit')}} {{__('messages.User')}}</button>
                    </div>
                </form>
            </div>
        </div>
