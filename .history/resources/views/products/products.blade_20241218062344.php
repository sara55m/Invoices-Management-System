            ...
            <div class="modal-content">
                ...
                <form action='products/update' method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" name="product_id" id="product_id" value="" >
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">{{__('messages.Cancel')}}Close</button>
                    </div>
                </form>
            </div>
        </div>
