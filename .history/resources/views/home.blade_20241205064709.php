...
@section('title')
Invoices Web Application Dashboard
@stop
@section('css')
<!--  Owl-carousel css-->
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										...
										<span class="float-right my-auto mr-auto">
											...
											<span class="text-white op-7">{{number_format((((App\Models\Invoices::where('Value_Status',2)->count())/(App\Models\Invoices::count()))*100),1)}}%</span>
										</span>
									</div>
								</div>
							</div>
