                                    ...
                                    <td>
                                        ...
                                        @if ($role->name !== 'Admin')
                                            ...
                                            <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                                ...
                                                data-toggle="modal" href="#modaldemo8" title="Delete">{{__('messages.Delete')}}</a>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">{{__('messages.Delete')}} {{__('messages.User Authority')}}</h6><button aria-label="Close" class="close"
...
<script src="{{ URL::asset('assets/plugins/notify/js/notifit-custom.js') }}">
