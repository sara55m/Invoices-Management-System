...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">{{__('messagesUsers Authorities')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/{{__('messages.Edit')}} {{__('messages.User Authority')}}</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
        ...
        <div class="card mg-b-20">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <ul id="treeview1">
                            <li><a href="#">{{__('messages.Authorities')}}Authorities</a>
                                <ul>
                                    <li>
