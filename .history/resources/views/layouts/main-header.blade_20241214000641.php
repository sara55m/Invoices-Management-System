                        ...
                        <div class="menu-header-content bg-primary text-right">
                            <div class="d-flex">
                                ...
                                <span class="badge badge-pill badge-warning mr-auto my-auto float-left"><a
                                        href="\MarkAsRead_all">{{ __('messages.mark_all') }}</a></span>
                            </div>
                            <p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">
                            <h6 style="color: yellow" id="notifications_count">
                                {{ __('messages.you_have') }} {{ auth()->user()->unreadNotifications->count() }} By {{ __('messages.unread_notifications') }}
                            </h6>
                            </p>
                        </div>
                    ...
                    <div class="dropdown-menu">
                        ...
                        <div id="unreadNotifications">
                                ...
                                <div class="main-notification-list Notification-scroll">
                                        ...
                                        <span class="badge badge-pill badge-warning mr-auto my-auto float-left"><a href="/MarkAsRead/{{$notification->id}}">{{ __('messages.mark') }}</a></span>
                                </div>
                            </a>
                                @endforeach
                        </div>
