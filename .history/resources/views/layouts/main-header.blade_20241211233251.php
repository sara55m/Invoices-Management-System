            ...
            <ul class="nav">
                <li class="">
                    <div class="dropdown  nav-itemd-none d-md-flex">
                        <a href="{{ url('/lang/en') }}" class="d-flex  nav-item nav-link pl-0 country-flag1" data-toggle="dropdown" aria-expanded="false">
                            <span class="mr-0 align-self-center text-dark">EN</span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow" x-placement="bottom-end">
                            <a href="{{ url('/lang/ar') }}" class="dropdown-item d-flex ">
                                <span class="mr-0 align-self-center text-dark">AR</span>
                            </a>
                ...
                <div class="dropdown nav-item main-header-notification">
                    ...
                    <div class="dropdown-menu">
                        <div class="menu-header-content bg-primary text-right">
                            <div class="d-flex">
                                <h4 class="dropdown-title mb-1 tx-15 text-white font-weight-semibold">Notifications</h4>
