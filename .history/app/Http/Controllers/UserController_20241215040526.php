    ...
    public function store(Request $request){
        $this->validate($request,
            [
                ...
                'status'=>'nullable',
                'roles' => 'array',
                'image'=>'file|mimes:png,jpg,jpeg,pdf'
            ]
            );
            //create new user
            $user = User::create([
            ...
            //moving the image into the images folder by its original name:
            $request->image->move(public_path('assets/images/' . $user->name), $imageName);
            }
