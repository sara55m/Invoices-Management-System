...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('home',compact('chart','chart2','total','paid','unpaid','partially','unpaidper','paidper','partiallyper'));

        }else{
            $total,$paid,$unpaid,$partially,$unpaidper,$paidper,$partiallyper=0;
            return view('home');
        }
