...
class HomeController extends Controller
{
    ...
    {
        //dd(Auth::user()->roles()->pluck('name','role_id'));
        //get user permisions
        //dd(Auth::user()->permissions()->pluck('name','permission_id'));
        $admin=Role::where('id',1)->first();
        $roles=Auth::user()->roles()->get();
        //dd($admin->users()->pluck('name','user_id'));
        //dd($roles->permissions()->pluck('name','permission_id'));
